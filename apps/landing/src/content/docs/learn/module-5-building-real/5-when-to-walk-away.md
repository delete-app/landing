...
1. **Satisfaction level** — Are you happy?
2. **Quality of alternatives** — What else is available? (Including being single)
3. **Investment size** — What would you lose by leaving?
...
1. **Anger issues/abusive behavior** — Most important dealbreaker
2. **Dating multiple partners** — Fundamental incompatibility
3. **Untrustworthy** — Foundation of relationship destroyed
